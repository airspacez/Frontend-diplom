...
export default function RecipeReviewCard(props) {
    ...
    const dateObj = new Date(data.game.date);
                ...
                <div className={styles.game_data_container}>
                    <div className={styles.game_data_block}>
                        <div className={styles.game_data}>
                            ...
                            <span className={styles.data}>{data.game.type.description}</span>
                        </div>
                        <div className={styles.game_data}>
                            <span className={styles.data_prefix}>РОЛЬ </span>
                            <span className={styles.data}>{data.role.name}</span>
                        </div>
                    </div>
                    <Hidden smDown>
                        <div className={styles.game_data_block}>
                            <div className={styles.game_data}>
                                ...
                                <span className={styles.data}>{data.game.place.description}, {data.game.place.city.name}, {data.game.place.address}</span>
                            </div>
                            <div className={styles.game_data}>
                    ...
                    <div className={styles.game_data_block}>
                        <div className={styles.game_data}>
                            ...
                            <span className={styles.data}>{data.game.table}</span>
                        </div>
                        <div className={styles.game_data}>
                            <span className={styles.data_prefix}>ИГРА </span>
                            <span className={styles.data}>{data.game.gameNumber}</span>
                        </div>
                    </div>
                    <div className={styles.game_result_container}>
                        <span className={styles.game_result_text}>{ data.win ? "ПОБЕДА":"ПОРАЖЕНИЕ"}</span>
                        <Hidden smDown><Button onClick={ ()=>HandleDetailsBtnClick(data.game.id)} className={styles.game_details_btn} variant="outlined">Детали</Button></Hidden>
                    </div>
                </div>
