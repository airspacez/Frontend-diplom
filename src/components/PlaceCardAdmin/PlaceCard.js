                ...
                <div className={styles.game_item}>
                    <div className={styles.game_data_container}>
                        ...
                        <div className={styles.game_data}>
                            ...
                            <span className={styles.data}>{data.description === "" ? "НЕТ ДАННЫХ" : data.description}</span>
                        </div>
                        <div className={styles.game_data}>
                            <span className={styles.data_prefix}>АДРЕС</span>
                            <span className={styles.data}>{data.address === "" ? "НЕТ ДАННЫХ" : data.address}</span>
                        </div>
                        <div className={styles.game_data}>
