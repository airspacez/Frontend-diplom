...
export default function UserProfile() {
    ...
    useEffect(() => {
        async function fetchStatistics() {
            const stats = await DataAccessService.getSimpleStatisticsById(userId);
            const userData = await DataAccessService.getUserDataById(userId);
            const lastGamesData = await DataAccessService.getUserLastGamesById(userId);
                    ...
                    <div className={styles.profile_info_container}>
                        ...
                        <div className={styles.profile_info_primary}>
                            ...
                            <div className={styles.profile_data}>
                                ...
                                <span className={styles.data}>{userData && userData.name !=="" ? userData.name : "Нет данных"}</span>
                            </div>
                            <div className={styles.profile_data}>
            ...
            <div className={styles.statistics_container}>
                ...
                <div className={styles.stats_content}>
                    ...
                    <div className={styles.winrate_container}>
                        ...
                        } value={userStatistics ? userStatistics.winRate : 0} >
                            <div className={styles}>
                                <div className={styles.stat_item_name}>ВИНРЕЙТ</div>
                                <div className={styles.stat_item_value}>{userStatistics ? userStatistics.winRate : 0}%</div>
                            </div>
